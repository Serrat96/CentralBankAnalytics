...
# Ratio oro/plata
gold_silver_ratio = pd.read_pickle('./02-Data/03-Gold_vs_silver_ratio/01-Gold_vs_silver_ratio.pkl')
...
inflation_annually = pd.read_pickle(r'..\02-Data\05-Inflation\01_Inflation_percentage_1913-01-01_2021-06-01_monthly_fred.pkl')
gold_annually = pd.read_pickle(r'..\02-Data\01-Gold\05-Gold_percentage_1968-04_2021-07_monthly_datahub.pkl')
...
inflation_annually_2 = pd.read_pickle(r'..\02-Data\05-Inflation\01_Inflation_percentage_1913-01-01_2021-06-01_monthly_fred.pkl')
m2_pct = pd.read_pickle(r'..\02-Data\06-M2\01_M2_percentage_1868-12-31-2021-01-01_yearly_fred.pkl')
...
interest_rates_10_year = pd.read_pickle(r'..\02-Data\07-Interest_rates\05-10YearTreasuryInflationIndexedSecurity_percentage_2003-01-02_2021-07-22_daily_fred.pkl')
gold_ounce = pd.read_pickle(r'..\02-Data\01-Gold\01_Gold_USD-GBP-EUR_1968-01-02_2021-07-22_daily_lbma.pkl')
...
silver_log = pd.read_pickle(r'..\02-Data\02-Silver\04_Silver_USD_1791-12-31_2020-12-31_yearly_logarithmic_denvergold.pkl')
...
silver_log_inflation = pd.read_pickle(r'..\02-Data\02-Silver\05-Silver_USD_inflation-adjusted_1791-12-31_2020-12-31_yearly_logarithmic_denvergold.pkl')
...
real_interest_rates_USA = pd.read_pickle(r'..\02-Data\08-Real_interest_rates\01-RealInterestRates_percentage_1954-07-01_2021-06-01_monthly_fred.pkl')
real_interest_rates_europe = pd.read_pickle(r'..\02-Data\11-Real_interest_rates_Europe\01-Real_interest_rates_2003-01-31_2021-05-31_monthly_ecb.pkl')
